...
async def parse_cmd():
    ...
    parser.add_argument('--platform', type=str, 
                        help='Media platform select / 选择媒体平台 (xhs=小红书 | dy=抖音 | ks=快手 | bili=哔哩哔哩 | wb=微博 | tieba=百度贴吧 | zhihu=知乎 | xueqiu=雪球 | reddit=Reddit | yt=YouTube)',
                        choices=["xhs", "dy", "ks", "bili", "wb", "tieba", "zhihu", "xueqiu", "reddit", "yt"], default=config.PLATFORM)
